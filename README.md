...
## 🏗️ Architecture
flowchart LR
    A[Browser<br/>Dashboard] -->|multipart/form-data| B[Flask API<br/>main.py]
    B --> C[modules/]
    C --> D[encryption.py<br/>AES-256-GCM]
    C --> E[digital_signature.py<br/>RSA-2048]
    C --> F[hash_generator.py<br/>SHA-256/512]
    C --> G[compressed_checker.py<br/>ZIP / TAR]
    C --> H[obfuscated_checker.py<br/>Risk scoring]
    B -->|JSON response| A
    B -->|file stream| I[/download/...]
    I --> A

    style A fill:#1e293b,stroke:#3b82f6,color:#fff
    style B fill:#0f172a,stroke:#10b981,color:#fff
